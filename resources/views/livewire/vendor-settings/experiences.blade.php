...
new class extends Component {
    public string $title = 'Experiences';
...
<section class="w-full">
    ...
    <x-vendor-settings.layout heading="Pengalaman Perusahaan" subheading="Tambahkan Portofolio perusahaan anda disini">
{{--        @livewire('vendor-settings.banks.table')--}}
        <blockquote>Data Pengalaman dan Portfolio Perusahaan</blockquote>
        <div x-data="{
                progress: 0,
