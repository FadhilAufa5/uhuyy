...
export class Toast {
    ...
    show(message, type = 'info', duration = 3000) {
        ...
        const icons = {
            ...
            warning: `<svg class="w-5 h-5 text-yellow-600 dark:text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>`,
        ...
        toast.innerHTML = `
            <div class="flex items-center gap-3 px-4 py-3 bg-white dark:bg-zinc-800 rounded-lg shadow-lg border border-gray-200 dark:border-zinc-700 min-w-[300px] max-w-md">
                <div class="flex-shrink-0">
                    ${icons[type] || icons.info}
                </div>
                <p class="text-sm font-medium text-gray-900 dark:text-gray-100 flex-1">${message}</p>
                <button onclick="this.closest('[class*=translate]').remove()" class="flex-shrink-0 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
